...
import { AlertCircle, Image as ImageIcon, Save, Upload } from 'lucide-react';
...
export default function EditGallery({ gallery }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit Foto', href: `/gallery/${gallery.id}/edit` },
    ];
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Foto yang sedang ditampilkan
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="relative aspect-video w-full overflow-hidden rounded-lg bg-muted">
                                <img
                                    src={previewUrl || gallery.image_url}
                                    alt={gallery.title}
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Ganti Foto (Opsional)</CardTitle>
                            <CardDescription>
                                Pilih foto baru jika ingin mengganti (Max 5MB)
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-4">
                                <div className="flex items-center justify-center">
                                    <label
                                        ...
                                        className="flex h-32 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-muted-foreground/25 bg-muted/50 transition-colors hover:border-muted-foreground/50 hover:bg-muted"
                                    >
                                        ...
                                        <div className="flex gap-2 rounded-md border border-blue-200 bg-blue-50 p-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm text-blue-800">
                                                    Mengubah tipe dari Pribadi
                                                    ke Publik akan memerlukan
                                                    persetujuan admin sebelum
                                                    foto ditampilkan di galeri
                                                    publik.
                                                </p>
                                            </div>
                                        </div>
